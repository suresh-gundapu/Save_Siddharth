...
},
{
  ...
  title_te: "CT Scan & పేగుల ప్రస్తుత పరిస్థితి",
  title_en: "CT Abdomen & Pelvis - Current Bowel Assessment",
  ...
  content_te:
    "RVM Hospital లో జరిగిన రెండు పెద్ద పేగుల ఆపరేషన్ల తరువాత ప్రస్తుతం పొత్తికడుపు లోపల పరిస్థితి ఎలా ఉందో తెలుసుకోవడానికి NIMS లో CT Abdomen & Pelvis మరియు రక్త పరీక్షలతో మళ్లీ అంచనా వేశారు. CT లో కొన్ని Small Bowel Loops ఇంకా fluid-filled గా ఉండటం మరియు Bowel Wall Edema (పేగు గోడల్లో వాపు) కనిపించింది. Liver ఎడమ భాగం దిగువ ప్రాంతంలో సుమారు 76 × 35 × 53 mm Loculated Collection, పొత్తికడుపులో Mild Free Fluid, Anterior Abdominal Wall లో Air Pockets మరియు రెండు వైపులా Moderate Pleural Effusion కూడా నమోదయ్యాయి. Distal Ileal Loop ప్రాంతంలో suspicious communication ఉన్నట్లు CT findings లో పేర్కొన్నారు. అంటే గత surgeries తర్వాత abdomen పూర్తిగా సాధారణ స్థితికి వచ్చిందని ఈ scan చెప్పడం లేదు; ఇంకా postoperative/inflammatory changes ఉన్నాయని చూపుతోంది. అయితే RVM లో గతంలో వేసిన రెండు Anastomosis కుట్లు ఇప్పుడు పూర్తిగా మానిపోయాయా లేదా మళ్లీ leak అవుతున్నాయా అనే విషయాన్ని CT report స్పష్టంగా నిర్ధారించలేదు. అలాగే పేగులు ప్రస్తుతం ఎంతవరకు ఒకదానికొకటి అతుక్కున్నాయి (Adhesions) అనే definitive finding కూడా ఈ CT report లో లేదు. Admission సమయంలో Sodium 125 mmol/L, Potassium 2.2 mmol/L వరకు తగ్గి ఉండటంతో పాటు nutritional condition కూడా మెరుగుపరచాల్సిన అవసరం ఉండటంతో NIMS doctors వెంటనే మరో major surgery చేయకుండా Conservative Management ఎంచుకున్నారు. Electrolyte Correction, High-Protein/High-Calorie Nutrition, Stoma Care మరియు Distal Refeeding ద్వారా ముందుగా శరీరాన్ని బలపరిచారు. Treatment తరువాత Sodium 139 mmol/L, Potassium 3.6 mmol/L వరకు మెరుగయ్యాయి; clinical condition మరియు oral intake మెరుగుపడటం, stoma healthy & functioning గా ఉండటంతో discharge చేశారు. ప్రస్తుతం ప్రధాన లక్ష్యం Nutrition మరియు overall strength మరింత మెరుగుపరచడం. Stoma Reversal ఎప్పుడు చేయవచ్చు, లోపల పేగులు surgery కి తగినంతగా heal అయ్యాయా, adhesions ఎంత ఉన్నాయి, పాత anastomosis ప్రాంతాలు ఎలా ఉన్నాయి అనే విషయాలను follow-up clinical evaluation మరియు అవసరమైన investigations తర్వాత Surgical Gastroenterology team నిర్ణయిస్తుంది. అందువల్ల ప్రస్తుతం Reversal Surgery కి ఖచ్చితమైన తేదీ లేదా success percentage చెప్పడానికి available reports సరిపోవు.",

  content_en:
    "Following two major bowel surgeries at RVM Hospital, NIMS reassessed the postoperative abdomen with CT Abdomen & Pelvis, laboratory investigations and clinical evaluation. CT demonstrated fluid-filled small bowel loops with bowel-wall edema, a loculated collection measuring approximately 76 × 35 × 53 mm beneath the left hepatic region, mild free intraperitoneal fluid, air pockets in the anterior abdominal wall and moderate bilateral pleural effusion. A suspicious communication involving the distal ileal loop was also described. These findings indicate that postoperative/inflammatory changes were still present and that the abdomen had not yet returned to a completely normal radiological appearance. However, the available CT report does not conclusively state whether the previous RVM anastomoses had completely healed or whether a persistent anastomotic leak remained. It also does not provide a definitive assessment of the presence or severity of intra-abdominal adhesions. At admission, significant electrolyte abnormalities were present, including Sodium of 125 mmol/L and Potassium of 2.2 mmol/L, along with the need for nutritional rehabilitation. Therefore, the NIMS team continued conservative management rather than proceeding immediately with another major operation. Treatment focused on electrolyte correction, high-protein/high-calorie nutritional support, stoma care and distal refeeding. Sodium subsequently improved to 139 mmol/L and Potassium to 3.6 mmol/L, with improvement in clinical condition and oral intake and a healthy functioning stoma at discharge. The current objective is continued nutritional and physical recovery. The timing and feasibility of Stoma Reversal Surgery, the condition of the previous anastomotic sites, and the extent of any adhesions will require reassessment by the Surgical Gastroenterology team during follow-up. The available reports do not support assigning a definite reversal date or a percentage probability of surgical success."
},
