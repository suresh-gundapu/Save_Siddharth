    ...
    <section className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-gray-100">
      ...
      <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center">
        ...
        <p className="text-gray-700 mb-8 text-base md:text-lg leading-relaxed">
          గత 45 రోజుల్లో ప్రాణాపాయ స్థితిలో రెండు పెద్ద సర్జరీలు. రక్తాన్ని కమ్మేసిన ఫంగస్ ఒకవైపైతే, తిన్నది జీర్ణం కాకముందే బయటకు వచ్చేస్తున్న కడుపులోని కన్నం (Jejunostomy) మరోవైపు నరకం చూపిస్తోంది. 40 కిలోల నుంచి 36 కిలోలకు అస్థిపంజరంలా మారిపోయిన సిద్ధు ప్రాణాలతో నిలబడాలంటే అత్యవసరంగా మూడో ఆపరేషన్ జరగాలి. ఇప్పటికే లక్షలు ఖర్చుపెట్టి అప్పుల ఊబిలో కూరుకుపోయిన ఆ నిరుపేద కుటుంబానికి ఇప్పుడు మీరే ఆఖరి ఆశ!
        </p>
